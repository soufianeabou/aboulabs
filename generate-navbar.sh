...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ width: '32px', height: '32px', filter: 'drop-shadow(0 0 8px rgba(0,245,196,0.6))' }}>
          <svg viewBox="0 0 100 100" fill="none" style={{ width: '100%', height: '100%' }}>
            <defs>
              <linearGradient id="navG1" x1="5" y1="5" x2="95" y2="85" gradientUnits="userSpaceOnUse">
                <stop offset="0%" stopColor="#00f5c4" />
                <stop offset="100%" stopColor="#39ff9a" />
              </linearGradient>
              <linearGradient id="navG2" x1="22" y1="48" x2="78" y2="85" gradientUnits="userSpaceOnUse">
                <stop offset="0%" stopColor="#00c4a7" />
                <stop offset="100%" stopColor="#00e5ff" />
              </linearGradient>
            </defs>
            <polygon points="50,5 95,85 5,85" fill="none" stroke="url(#navG1)" strokeWidth="8" />
            <polyline points="22,85 50,48 78,85" fill="none" stroke="url(#navG2)" strokeWidth="6" />
          </svg>
        </div>
        <span
          style={{
...
ENDOFFILE
echo "✅ Navbar.tsx created successfully"
ENDOFFILE
